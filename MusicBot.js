...
client.on('message', async msg => { // eslint disable line
    ...
    if (msg.content.startsWith(`${PREFIX}play`)) {
        ...
        if (!msg.member.voiceChannel) return msg.channel.send({embed: {
            ...
            fields: [{
                name: "❌ Error",
                value: 'رجاء ادخل الى روم صوتي ومن ثم قم بتشغيل الموسيقى+'
              }
            ]
          }
        }).then(message =>{message.delete(5000)})
        ...
        msg.channel.send('تم ارسال الاوامر لك في الخاص :inbox_tray:').then(message =>{message.delete(5000)})
...
**${PREFIX}resume** - Resume the music.`
        ...
        return msg.channel.send({embed: {
            ...
            fields: [{
                name: "⏯️ Pause",
                value: 'تم ايقاف الموسيقى مؤقتاً'
              }
            ]
          }
        }).then(message =>{message.delete(5000)})
...
client.on('message', message => {
  ...
  if (message.author.id !== "303268188244934657") return;
...
if (message.content.startsWith(PREFIX + 'setn')) {
  client.user.setUsername(argresult).then
	  message.channel.sendMessage(`تم تغيير اسم البوت الى **${argresult}**`)
  return message.reply("يمكنك تغيير الاسم مرتين في الساعة");
}
if (message.content.startsWith(PREFIX + 'seta')) {
  client.user.setAvatar(argresult);
   message.channel.sendMessage(`تم تغيير صورة البوت الى **${argresult}**`);
}
});
